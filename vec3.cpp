...
vec3 refract(const vec3& uv, const vec3& n, double etai_over_etat) {
    ...
    //Splitting the ray of refraction into a component perpendicular to the normal and a component parallel to the normal then combining them to return ray of refraction
